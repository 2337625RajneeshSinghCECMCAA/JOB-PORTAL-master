...
import rajneesh from "./rajneesh.jpg"; // Import the local image
import rohit from "./rohit.jpg";
import aman from "./aman.jpg";
import vishal1 from "./vishal1.jpg";
